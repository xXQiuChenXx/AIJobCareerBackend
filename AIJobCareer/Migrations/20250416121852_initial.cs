    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "petronas", 2, new DateTime(2017, 1, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(60), "", "Oil & Gas", "Oil and gas exploration company operating in Sarawak's offshore regions.", "Petronas Carigali Sdn Bhd", "https://www.petronas.com" },
                    { "sarawakenergy", 1, new DateTime(2015, 4, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(42), "", "Energy & Utilities", "Leading energy provider in Sarawak focusing on renewable energy sources.", "Sarawak Energy Berhad", "https://www.sarawakenergy.com" },
                    { "sarawakforestrycorporation", 1, new DateTime(2020, 1, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(63), "", "Forestry & Environmental Services", "Responsible for sustainable management of Sarawak's forest resources.", "Sarawak Forestry Corporation", "https://www.sarawakforestry.com" },
                    { "sdec", 5, new DateTime(2018, 1, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(65), "", "Technology & Digital Services", "Driving digital transformation and innovation across Sarawak.", "Sarawak Digital Economy Corporation", "https://www.sdec.com.my" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("07a947f2-2c71-4a13-9a23-11d69f794600"), null, new DateTime(2024, 7, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(105), 35, 2, null, "0167890123", "rajesh@example.com", "Rajesh", "rajesh_profile.jpg", "Petroleum engineer with 10 years experience in offshore drilling.", "Kumar", "hashed_password_3", "public", "job_seeker", "rajesh_kumar" },
                    { new Guid("26db79a8-d457-4884-be35-7263f2b94aa0"), null, new DateTime(2025, 1, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(101), 32, 3, null, "0123456789", "siti@example.com", "Siti", "siti_profile.jpg", "Environmental scientist with expertise in tropical forest conservation.", "Nur Aminah", "hashed_password_2", "private", "job_seeker", "siti_aminah" },
                    { new Guid("b132dd2d-3579-457f-8ea6-a8c84f8c65f6"), null, new DateTime(2024, 10, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(89), 28, 1, null, "0198765432", "ahmad@example.com", "Ahmad", "ahmad_profile.jpg", "Software developer with 5 years of experience in web technologies.", "bin Ibrahim", "hashed_password_1", "public", "job_seeker", "ahmad_ibrahim" }
                });

            migrationBuilder.InsertData(
                table: "JOB",
                columns: new[] { "job_id", "job_benefit", "job_company_id", "job_deadline", "job_description", "job_location", "job_requirement", "job_responsible", "job_salary_max", "job_salary_min", "job_status", "job_title", "job_type", "posted_date" },
                values: new object[,]
                {
                    { 1, "Health insurance,\nPerformance bonus,\nProfessional development allowance.", "sarawakenergy", new DateTime(2025, 5, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(123), "Develop and maintain enterprise software applications for energy management systems.", "Kuching, Sarawak", "Bachelor's degree in Computer Science,\n5+ years experience in software development.", "Lead software development projects,\nMentor junior developers,\nCollaborate with stakeholders.", 7500.00m, 5000.00m, "Open", "Senior Software Developer", "Full_Time", new DateTime(2025, 3, 27, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(121) },
                    { 2, "Housing allowance,\nTransportation,\nMedical coverage,\nAnnual bonus.", "petronas", new DateTime(2025, 5, 20, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(128), "Design and implement strategies for efficient oil and gas extraction. Collaborate with multidisciplinary teams to solve complex drilling challenges.", "Miri, Sarawak", "Bachelor's degree in Petroleum Engineering,\n5+ years field experience.", "Oversee drilling operations,\nOptimize oil extraction processes,\nCoordinate with field teams.", 9000.00m, 6500.00m, "Open", "Petroleum Engineer", "Contract", new DateTime(2025, 4, 6, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(127) },
                    { 3, "Field allowance,\nGovernment pension scheme,\nPaid study leave.", "sarawakforestrycorporation", new DateTime(2025, 5, 26, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(131), "Monitor forest health, implement conservation programs, and work with local communities to promote sustainable forest management practices.", "Kuching, Sarawak (with field work)", "Bachelor's degree in Forestry or Environmental Science,\nKnowledge of local ecosystems.", "Implement and monitor conservation programs,\nEngage with local communities,\nReport on ecosystem health.", 5500.00m, 4000.00m, "Open", "Forest Conservation Officer", "Part_Time", new DateTime(2025, 2, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(131) },
                    { 4, "Performance bonuses,\nFlexible working arrangements,\nTraining opportunities.", "sdec", new DateTime(2025, 1, 15, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(135), "Create and execute digital marketing campaigns to promote Sarawak's digital initiatives across various platforms and channels.", "Samarahan, Sarawak", "Bachelor's degree in Marketing or Communications,\nExperience with digital marketing tools.", "Develop digital marketing strategies,\nManage social media and PPC campaigns,\nAnalyze performance metrics.", 5000.00m, 3500.00m, "Closed", "Digital Marketing Specialist", "Full_Time", new DateTime(2024, 12, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(134) },
                    { 5, "Professional development fund,\nHealth insurance,\nPerformance bonus.", "sarawakenergy", new DateTime(2025, 4, 21, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(139), "Evaluate renewable energy projects, conduct feasibility studies, and provide recommendations for sustainable energy solutions.", "Kuching, Sarawak", "Bachelor's degree in Environmental Engineering or related field,\nKnowledge of renewable energy technologies.", "Analyze project feasibility,\nModel energy outputs,\nPrepare recommendation reports.", 6000.00m, 4500.00m, "Open", "Renewable Energy Analyst", "Internship", new DateTime(2025, 3, 7, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(137) },
                    { 6, "Remote work options,\nMedical coverage,\nProfessional development.", "sarawakforestrycorporation", new DateTime(2025, 4, 27, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(144), "Develop and maintain web applications that support Sarawak's digital economy initiatives, from database design to user interface implementation.", "Samarahan, Sarawak", "Bachelor's degree in Computer Science,\nProficiency in front‑end and back‑end technologies.", "Design and develop web applications,\nMaintain backend services,\nImplement user-friendly interfaces.", 7000.00m, 4800.00m, "Open", "Full Stack Developer", "Full_Time", new DateTime(2025, 3, 13, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(143) },
                    { 7, "Health insurance,\nStock options,\nTraining budget.", "sarawakenergy", new DateTime(2025, 5, 16, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(148), "Analyze large datasets to extract insights and build predictive models for energy demand forecasting.", "Kuching, Sarawak", "Bachelor's/Master's in Data Science or related,\n3+ years experience in data analytics,\nProficiency in Python and ML frameworks.", "Develop data pipelines,\nBuild and validate predictive models,\nPresent findings to stakeholders.", 8500.00m, 6000.00m, "Open", "Data Scientist", "Full_Time", new DateTime(2025, 4, 1, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(147) },
                    { 8, "Housing allowance,\nMedical coverage,\nAnnual bonus.", "petronas", new DateTime(2025, 5, 1, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(151), "Plan and supervise infrastructure projects including roads, bridges, and public facilities.", "Miri, Sarawak", "Bachelor's degree in Civil Engineering,\n4+ years site experience,\nKnowledge of local building codes.", "Design structural plans,\nOversee construction sites,\nEnsure compliance with safety standards.", 8000.00m, 5500.00m, "Open", "Civil Engineer", "Full_Time", new DateTime(2025, 3, 22, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(151) },
                    { 9, "Field allowance,\nFlexible schedule,\nEquipment provision.", "sarawakforestrycorporation", new DateTime(2025, 5, 21, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(154), "Manage GIS databases to support forestry conservation and land management.", "Samarahan, Sarawak", "Bachelor's in Geography/GIS,\nProficiency in ArcGIS/QGIS,\n2+ years GIS experience.", "Develop and maintain GIS maps,\nConduct spatial analysis,\nTrain staff on GIS tools.", 6500.00m, 4500.00m, "Open", "GIS Specialist", "Contract", new DateTime(2025, 4, 11, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(154) },
                    { 10, "Flexible working hours,\nHealth coverage,\nProfessional development.", "sdec", new DateTime(2025, 5, 19, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(157), "Design intuitive user interfaces for web and mobile applications to enhance user experience.", "Kuching, Sarawak", "Bachelor's in Design or HCI,\n3+ years UX/UI experience,\nProficiency in Figma and Sketch.", "Create wireframes and prototypes,\nConduct user research,\nCollaborate with developers.", 7000.00m, 5000.00m, "Open", "UX Designer", "Full_Time", new DateTime(2025, 4, 4, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(157) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "sarawakenergy", "unread", "Your application for Senior Software Developer has been received. We will review it shortly.", new DateTime(2025, 4, 6, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(239), new Guid("b132dd2d-3579-457f-8ea6-a8c84f8c65f6") },
                    { 2, "sarawakforestrycorporation", "read", "You have been shortlisted for the Forest Conservation Officer position. Please prepare for an interview.", new DateTime(2025, 4, 8, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(242), new Guid("26db79a8-d457-4884-be35-7263f2b94aa0") },
                    { 3, "petronas", "unread", "Thank you for your application to Petronas Carigali. Your application is under review.", new DateTime(2025, 4, 11, 20, 18, 52, 639, DateTimeKind.Local).AddTicks(243), new Guid("07a947f2-2c71-4a13-9a23-11d69f794600") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new Guid("b132dd2d-3579-457f-8ea6-a8c84f8c65f6") },
                    { 2, 7, new Guid("26db79a8-d457-4884-be35-7263f2b94aa0") },
                    { 3, 5, new Guid("07a947f2-2c71-4a13-9a23-11d69f794600") }
                });
