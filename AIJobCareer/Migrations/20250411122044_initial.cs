    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "petronas", 2, new DateTime(2017, 1, 11, 20, 20, 44, 172, DateTimeKind.Local).AddTicks(6500), "petronas_icon.png", "Oil & Gas", "Oil and gas exploration company operating in Sarawak's offshore regions.", "Petronas Carigali Sdn Bhd", "https://www.petronas.com" },
                    { "sarawakenergy", 1, new DateTime(2015, 4, 11, 20, 20, 44, 172, DateTimeKind.Local).AddTicks(6482), "sarawak_energy_icon.png", "Energy & Utilities", "Leading energy provider in Sarawak focusing on renewable energy sources.", "Sarawak Energy Berhad", "https://www.sarawakenergy.com" },
                    { "sarawakforestrycorporation", 1, new DateTime(2020, 1, 11, 20, 20, 44, 172, DateTimeKind.Local).AddTicks(6505), "sfc_icon.png", "Forestry & Environmental Services", "Responsible for sustainable management of Sarawak's forest resources.", "Sarawak Forestry Corporation", "https://www.sarawakforestry.com" },
                    { "sdec", 5, new DateTime(2018, 1, 11, 20, 20, 44, 172, DateTimeKind.Local).AddTicks(6508), "sdec_icon.png", "Technology & Digital Services", "Driving digital transformation and innovation across Sarawak.", "Sarawak Digital Economy Corporation", "https://www.sdec.com.my" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("15ed8d25-9e29-471d-8716-d11c5836362e"), null, new DateTime(2024, 7, 11, 20, 20, 44, 172, DateTimeKind.Local).AddTicks(6547), 35, 2, null, "0167890123", "rajesh@example.com", "Rajesh", "rajesh_profile.jpg", "Petroleum engineer with 10 years experience in offshore drilling.", "Kumar", "hashed_password_3", "public", "job_seeker", "rajesh_kumar" },
                    { new Guid("ca49b1ca-6b66-45e3-a712-539e66342676"), null, new DateTime(2025, 1, 11, 20, 20, 44, 172, DateTimeKind.Local).AddTicks(6543), 32, 3, null, "0123456789", "siti@example.com", "Siti", "siti_profile.jpg", "Environmental scientist with expertise in tropical forest conservation.", "Nur Aminah", "hashed_password_2", "private", "job_seeker", "siti_aminah" },
                    { new Guid("d683f289-d5cd-47a1-834b-68dd0d806371"), null, new DateTime(2024, 10, 11, 20, 20, 44, 172, DateTimeKind.Local).AddTicks(6538), 28, 1, null, "0198765432", "ahmad@example.com", "Ahmad", "ahmad_profile.jpg", "Software developer with 5 years of experience in web technologies.", "bin Ibrahim", "hashed_password_1", "public", "job_seeker", "ahmad_ibrahim" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "sarawakenergy", "unread", "Your application for Senior Software Developer has been received. We will review it shortly.", new DateTime(2025, 4, 1, 20, 20, 44, 172, DateTimeKind.Local).AddTicks(6627), new Guid("d683f289-d5cd-47a1-834b-68dd0d806371") },
                    { 2, "sarawakforestrycorporation", "read", "You have been shortlisted for the Forest Conservation Officer position. Please prepare for an interview.", new DateTime(2025, 4, 3, 20, 20, 44, 172, DateTimeKind.Local).AddTicks(6630), new Guid("ca49b1ca-6b66-45e3-a712-539e66342676") },
                    { 3, "petronas", "unread", "Thank you for your application to Petronas Carigali. Your application is under review.", new DateTime(2025, 4, 6, 20, 20, 44, 172, DateTimeKind.Local).AddTicks(6633), new Guid("15ed8d25-9e29-471d-8716-d11c5836362e") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new Guid("d683f289-d5cd-47a1-834b-68dd0d806371") },
                    { 2, 7, new Guid("ca49b1ca-6b66-45e3-a712-539e66342676") },
                    { 3, 5, new Guid("15ed8d25-9e29-471d-8716-d11c5836362e") }
                });
